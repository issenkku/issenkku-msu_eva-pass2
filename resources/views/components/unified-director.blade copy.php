                                    ...
                                    <div class="mt-6">
                                        @foreach($evaluationList['quality_items'] as $mainCriteria)
                                            <details class="group border border-gray-300 rounded-lg bg-white mb-6">
                                                ...
                                                <div class="px-4 py-4">
                                                    <div class="main-criteria" data-ratio="{{ $mainCriteria['ratio'] }}" data-sum-score="{{ $evaluationList['sum_score'] }}" data-main-id="{{ $mainCriteria['id'] }}">
                                                        @if(!empty($mainCriteria['tooltips']))
                                                        ...
                                                        <div class="space-y-3 ml-2">
                                                            ...
                                                            @php
                                                                $evidenceLinks = (array)($qualityEvidenceMap[$mainCriteria['id']] ?? []);
                                                                $evidenceCount = count(array_filter($evidenceLinks));
                                                            @endphp
                                                            <details class="group mt-5 border-t border-gray-200 pt-4">
                                                                <summary class="list-none [&::-webkit-details-marker]:hidden cursor-pointer">
                                                                    <div class="flex items-center justify-between">
                                                                        <h3 class="text-base font-semibold text-gray-800 flex items-center">
                                                                            ...
                                                                            หลักฐาน
                                                                            @if($evidenceCount > 0)
                                                                                <span class="ml-2 inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-1 rounded-full">
                                                                                    {{ $evidenceCount }} ลิงก์
                                                                                </span>
                                                                            @endif
                                                                        </h3>
                                                                ...
                                                                <div class="mt-3">
                                                                    @if($evidenceCount > 0)
                                                                        ...
                                                                        @endforeach
                                                                    @else
                                                                        <div class="text-gray-500 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                                                            ไม่มีหลักฐานแนบ
                                                                        </div>
                                                                    @endif
                                                                </div>
