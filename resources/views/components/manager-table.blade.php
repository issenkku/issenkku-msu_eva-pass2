...
<div id="managerReviewerModal" class="hidden fixed inset-0 z-50 bg-slate-900/50 p-4">
    <div class="flex h-full min-h-0 items-center justify-center">
        <div data-reviewer-list-modal-panel class="flex max-h-[calc(100dvh-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white shadow-xl">
            ...
            <div id="managerReviewerModalBody" data-reviewer-list-modal-body class="min-h-0 flex-1 space-y-3 overflow-y-auto overscroll-contain px-5 py-5"></div>
        </div>
    </div>
</div>
