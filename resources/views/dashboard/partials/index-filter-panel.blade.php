    ...
    <button
        ...
        <div class="flex items-center gap-2.5">
            ...
            <div>
                ...
                <p data-dashboard-filter-summary class="mt-0.5 text-xs text-gray-500 sm:text-sm">
        ...
        <div class="flex items-center gap-2">
            <span
                ...
                class="{{ $hasDashboardFilters ? 'inline-flex' : 'hidden' }} rounded-full bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-700 ring-1 ring-blue-100">
                กำลังกรอง
            </span>
