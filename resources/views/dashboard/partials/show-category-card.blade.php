{{-- การ์ดหมวดหมู่หลักของผลการประเมิน --}}
<div class="category-card">
    ...
    @include('dashboard.partials.show-quantity-section', ['category' => $category])
    @include('dashboard.partials.show-quality-section', ['category' => $category])
</div>
