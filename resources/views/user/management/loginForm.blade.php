        ...
        <div class="form-wrap">
            ...
            <section class="form-card">
                ...
                <form id="loginForm" autocomplete="on">
                    ...
                    <div class="field">
                        ...
                        <div class="input-box">
                            ...
                            <input
                                ...
                                required>
                            <button class="toggle-pw" type="button" onclick="togglePassword()" aria-label="แสดงหรือซ่อนรหัสผ่าน">
                    ...
                    {{-- <div class="help-text">
                        มีปัญหาเข้าสู่ระบบ? <a href="mailto:admin@msu.ac.th">ติดต่อผู้ดูแลระบบ</a>
                    </div> --}}
                </form>
            </section>
