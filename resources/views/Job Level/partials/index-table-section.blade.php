...
<div class="table-container" data-reorder-table data-reorder-url="{{ route('job-level.reorder') }}" data-can-reorder="{{ $canReorder ? 1 : 0 }}" data-start-order="{{ $jobLevels->firstItem() ?? 1 }}">
