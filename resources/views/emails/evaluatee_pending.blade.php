<div style="font-family: Tahoma, Arial, sans-serif; font-size: 16px; color: #222;">
    ...
    <p>เรียนคุณ {{ $name }},</p>
    <p>ผลการประเมินหัวข้อ <strong>{{ $report_title }}</strong> ({{ $version_name ?? '-' }}) ของผู้รับการประเมิน {{ $evaluatee_name }} ถูกส่งเข้ามาให้คุณตรวจสอบแล้ว</p>
    ...
    <p>กรุณาเข้าสู่ระบบเพื่อตรวจสอบรายละเอียดและดำเนินการในขั้นตอนถัดไป</p>
