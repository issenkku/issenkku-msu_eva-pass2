...
final class SupportScoreRules
{
    ...
    public static function validation(): array
    {
        return [
            ...
            'support_list.*.achieved_score' => ['nullable', 'numeric', 'multiple_of:1', 'between:1,5'],
            ...
            'support_list.*.activity_entries.*.achieved_score' => ['nullable', 'numeric', 'multiple_of:1', 'between:1,5'],
