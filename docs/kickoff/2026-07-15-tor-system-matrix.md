...
| นำคะแนนภาระงานไปใช้ในแบบประเมินเดิม | ยืนยันด้วยหลักฐาน | แสดงคะแนนภาระงานตามรายงานและเกณฑ์ย่อยเดียวกับแบบประเมิน | TOR ข้อ 4.4.2 และข้อ 5; `app/Http/Controllers/Evaluatee/EvaluationWorkloadController.php`; `app/Models/QuantityScore.php`; `tests/Feature/Evaluation/EvaluateeTest.php`; `tests/Feature/WorkloadFormulaEvaluatorTest.php` | ระบบคำนวณและบันทึกคะแนนภาระงานตามรายงานและเกณฑ์ย่อยภายในกระบวนการประเมินเดิม โดยต้องยืนยันข้อมูลตัวอย่างและผลคะแนนกับผู้ใช้ในการทดสอบ UAT ครับ |
...
6. แสดงว่าคะแนนถูกบันทึกตามรายงานและเกณฑ์ย่อยเดียวกับแบบประเมิน แล้วปิดเดโมด้วย Audit Log หรือผลทดสอบ
...
- การจับคู่คะแนนกับรายงานและเกณฑ์ย่อย ผู้ตรวจสอบความถูกต้อง และข้อมูลทดสอบ
